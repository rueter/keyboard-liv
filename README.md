# Keyboards for the Liv language

This directory contains source files and build instructions for
developing keyboards for the Liv language. The data and implementations
...
-   <http://giellatekno.uit.no/livdoc/index.html>
-   <https://giellalt.uit.no/tools/docu-liv-manual.html>
...
The Liv keyboard sources can be acquired using the [Giella SVN
